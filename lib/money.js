 ...
 * @type {Money}
 */
Money.ONE = new Money(0, Money.BASE, new Date());
 ...
 * @type {Money}
 */
Money.TEN = new Money(0, Money.BASE, new Date());
 ...
 * @type {Money}
 */
Money.TWENTY = new Money(0, Money.BASE, new Date());
 ...
 * @type {Money}
 */
Money.FIFTY = new Money(0, Money.BASE, new Date());
 ...
 * @type {Money}
 */
Money.HUNDRED = new Money(0, Money.BASE, new Date());
 ...
 * @type {Money}
 */
Money.THOUSAND = new Money(0, Money.BASE, new Date());


/**
 * @description get exchanges rates to be used in exchanging one money to another
 *              This must be overriden before using money for convertion/exchange.
 *              
